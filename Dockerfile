...
RUN mkdir /home/morphs/ImageUploadServerGo
COPY . /home/morphs/ImageUploadServerGo
RUN chown -R $USERNAME:$USERNAME /home/morphs/ImageUploadServerGo
USER $USERNAME
WORKDIR /home/$USERNAME

# Install Node , for puppeteer
RUN sudo apt-get install nodejs npm -y
RUN sudo apt-get install chromium -y
RUN sudo npm install puppeteer -g
